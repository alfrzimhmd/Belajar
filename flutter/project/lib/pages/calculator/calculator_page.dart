...
class _CalculatorPageState extends State<CalculatorPage> {
  String _display = '0'; // Tampilan angka yang sedang diketik
  String _operation = ''; // Operasi saat ini (+, -, ×, ÷)
  double _num1 = 0; // Angka pertama
  double _num2 = 0; // Angka kedua
  bool _shouldReset = false; // Menandakan apakah display perlu direset setelah operasi
  final List<String> _history = []; // Riwayat perhitungan
  ...
  void _calculate() {
    ...
    switch (_operation) {
      ...
      case '÷':
        ...
        break;
      case '%':
      // Kalkulator biasa: 200 + 10% = 220 (10% dari 200 ditambahkan)
      // Kalkulator matematis: 10 % 3 = 1 (modulus)
        if (_operation == '%' && _num1 != 0) {
          // Jika sebelumnya operator adalah + atau -, hitung persentase
          ...
          // Jika tidak, lakukan modulus seperti biasa
          result = _num1 % _num2;
        }
        break;
    }
  ...
  /// Fungsi logout ke halaman splash
  void _logout() {
