...
import 'package:test_multipage/pages/notif/notif_page.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  final List<Widget> _pages = [
    const CounterPage(),        // Halaman counter
    const WordgeneratePage(),   // Halaman generator kata
    const NotificationPage(),
    const CalculatorPage(),     // Halaman kalkulator
    const QuotesPage(),         // Halaman quotes
    const DrawingPage(),        // Halaman menggambar
    ...
    return SafeArea(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.black.withAlpha(20), // Shadow dengan transparansi
              blurRadius: 8,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12), // Border radius melengkung
        ...
        child: Row(
          ...
          children: [
            ...
            Icon(
              icon,
              size: 22,
              // Warna biru jika dipilih, abu-abu jika tidak
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 12,
                // Font weight lebih tebal jika dipilih
